...
class DataProcessor(object):
    ...
    def plot_scenario(self, data, cnt=0):
        ...
        plt.tight_layout()
        plt.savefig(f'scenarios/scenario_plot_{cnt}.png', dpi=600)
        plt.clf()
        # plt.show()
...
if __name__ == "__main__":
    ...
    scenario_filter = ScenarioFilter(*get_filter_parameters_for_changing_lane(num_scenarios_per_type=100, 
